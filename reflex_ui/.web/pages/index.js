...
export function Comp_60d07616ec54dde45d1dd65e387230df () {
  ...
  const { getRootProps: trfodatj, getInputProps: erjbtvot, isDragActive: zabejesz} = useDropzone(({ ["onDrop"] : on_drop_c761e72ff168a04e764418aa8b1588cf, ["multiple"] : true, ["id"] : "chat_file_upload" }));
...
jsx(
RadixThemesBox,
{className:"rx-Upload flex-shrink-0",id:"chat_file_upload",ref:ref_chat_file_upload,...trfodatj()},
jsx("input",{type:"file",...erjbtvot()},)
,jsx(
"div",
...
export function Flex_21d62df739ec30ce23bf09721a12dcb6 () {
...
reflex___state____state__app___states___chat_state____chat_state.messages.map((message,index_ad54f1caffa74761)=>(jsx(
RadixThemesBox,
{css:({ ["alignSelf"] : (message["is_ai"] ? "start" : "end"), ["background"] : (message["is_ai"] ? "gray.100" : "blue.100"), ["padding"] : "0.5rem", ["borderRadius"] : "lg", ["maxWidth"] : "70%" }),key:index_ad54f1caffa74761},
jsx(
RadixThemesText,
{as:"p"},
message["text"]
...
export function Div_ce35431cd17caa907c27648b293e8fd8 () {
...
reflex___state____state__app___states___chat_state____chat_state.alignment_options.map((option,index_54ab5370856fac04)=>(jsx(
"label",
{className:"flex items-center cursor-pointer",key:index_54ab5370856fac04},
...
export function Form_c4ef555ebc91b98c27a40f0686dbf1ef () {
  
  const [addEvents, connectErrors] = useContext(EventLoopContext);

  
    const handleSubmit_687afc4111168c7a93f492c6db206b4a = useCallback((ev) => {
  ...
  return (
    jsx(
"form",
{className:"w-full",onSubmit:handleSubmit_687afc4111168c7a93f492c6db206b4a},
jsx(
"div",
...
jsx(Comp_60d07616ec54dde45d1dd65e387230df,{},)
...
jsx(Flex_21d62df739ec30ce23bf09721a12dcb6,{},)
,jsx(
"div",
...
,jsx(Div_ce35431cd17caa907c27648b293e8fd8,{},)
,),jsx(Form_c4ef555ebc91b98c27a40f0686dbf1ef,{},)
