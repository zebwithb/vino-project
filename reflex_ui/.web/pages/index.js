...
export function Comp_7bf8b19f26c51471e89c95da6466d1d3 () {
  ...
  const { getRootProps: fhlpzyhf, getInputProps: wtvbqmoi, isDragActive: vagkxxde} = useDropzone(({ ["onDrop"] : on_drop_c761e72ff168a04e764418aa8b1588cf, ["multiple"] : true, ["id"] : "chat_file_upload" }));
...
jsx(
RadixThemesBox,
{className:"rx-Upload flex-shrink-0",id:"chat_file_upload",ref:ref_chat_file_upload,...fhlpzyhf()},
jsx("input",{type:"file",...wtvbqmoi()},)
,jsx(
"div",
...
export function Flex_5644725dd75558d2bca9829005b41284 () {
...
reflex___state____state__app___states___chat_state____chat_state.messages.map((message,index_1d42aff46fca1563)=>(jsx(
RadixThemesBox,
{css:({ ["alignSelf"] : (message["is_ai"] ? "start" : "end"), ["background"] : (message["is_ai"] ? "gray.100" : "blue.100"), ["padding"] : "0.5rem", ["borderRadius"] : "lg", ["maxWidth"] : "70%" }),key:index_1d42aff46fca1563},
jsx(
RadixThemesText,
{as:"p"},
message["text"]
...
export function Div_bce8df14b06086fd3cfe15db7246c7b2 () {
...
reflex___state____state__app___states___chat_state____chat_state.alignment_options.map((option,index_fabd768b9761bae0)=>(jsx(
"label",
{className:"flex items-center cursor-pointer",key:index_fabd768b9761bae0},
...
export function Fragment_ff2b3b266bcf2e08f78033df57c1e01e () {
...
export function Form_b4912fd55e6f98f9949e0f4b815ab455 () {
  
  const [addEvents, connectErrors] = useContext(EventLoopContext);

  
    const handleSubmit_49f2cf65b3869799422ffce52908d531 = useCallback((ev) => {
  ...
  return (
    jsx(
"form",
{className:"w-full",onSubmit:handleSubmit_49f2cf65b3869799422ffce52908d531},
jsx(
"div",
...
jsx(Comp_7bf8b19f26c51471e89c95da6466d1d3,{},)
...
,),jsx(Fragment_ff2b3b266bcf2e08f78033df57c1e01e,{},)
,)
  )
}
...
jsx(Flex_5644725dd75558d2bca9829005b41284,{},)
,jsx(
"div",
...
,jsx(Div_bce8df14b06086fd3cfe15db7246c7b2,{},)
,),jsx(Form_b4912fd55e6f98f9949e0f4b815ab455,{},)
